 ...
 *
 */
public class WeiXinOrderCloseReqData {
     ...
     * @throws Exception
     */
    public WeiXinOrderCloseReqData(String transactionID, String outTradeNo){
	...
	public String toString() {
		return "WeiXinOrderCloseReqData [appid=" + appid + ", mch_id=" + mch_id
