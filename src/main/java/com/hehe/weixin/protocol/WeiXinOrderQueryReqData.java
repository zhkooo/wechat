 ...
 *
 */
public class WeiXinOrderQueryReqData {
     ...
     * @throws Exception
     */
    public WeiXinOrderQueryReqData(String transactionID, String outTradeNo){
	...
	public String toString() {
		return "WeiXinOrderQueryReqData [appid=" + appid + ", mch_id=" + mch_id
