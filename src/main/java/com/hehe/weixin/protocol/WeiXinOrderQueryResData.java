 ...
 *
 */
public class WeiXinOrderQueryResData {
	...
	public String toString() {
		return "WeiXinOrderQueryResData [return_code=" + return_code
				...
				+ ", trade_state=" + trade_state + ", device_info="
				...
				+ coupon_fee + ", fee_type=" + fee_type + ", cash_fee="
